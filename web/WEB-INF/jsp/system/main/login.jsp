...
<body class="loginBody">
	<form class="layui-form" id="loginFrm" method="post" action="<%=request.getContextPath()%>/login/login">
		<div class="login_face"><img src="<%=request.getContextPath()%>/resources/images/face1.jpg" class="userAvatar"></div>
		...
		<div class="layui-form-item input-item" id="imgCode">
			...
			<img  src="<%=request.getContextPath()%>/login/getCode" onclick="this.src = this.src+'?'">
		</div>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/cache.js"></script>
