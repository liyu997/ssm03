...
<body class="main_body">
			...
			<div class="navBar layui-side-scroll" id="navBar">
				<ul class="layui-nav layui-nav-tree">
					<li class="layui-nav-item layui-this">
						<a href="javascript:;" data-url="desk/toDeskManager"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<div class="layui-tab-content clildFrame">
					<div class="layui-tab-item layui-show">
						<iframe src="<%=request.getContextPath()%>/desk/toDeskManager"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	layui.config({
		base : "<%=request.getContextPath()%>/resources/js/"
	}).extend({
		"bodyTab" : "bodyTab"
	})
	layui.use(['bodyTab','form','element','layer','jquery'],function(){
		var form = layui.form,
			...
			tab = layui.bodyTab({
				...
				url : "/SSM/menu/loadIndexLeftMenuJson" //获取菜单json地址
			});
